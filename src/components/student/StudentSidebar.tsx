import { Home, BookOpen, MessageSquare, FileText, Calendar, UserPlus, HelpCircle, User, LogOut } from 'lucide-react';
...
export function StudentSidebar({ currentView, onNavigate, onLogout, userName, userEmail }: StudentSidebarProps) {
  const menuItems = [
    ...
    { id: 'matricularse', label: 'Matricularse', icon: UserPlus },
    { id: 'soporte', label: 'Soporte/Ayuda', icon: HelpCircle },
    ...
    <aside className="w-64 bg-gray-900 text-white flex flex-col">
      ...
      <nav className="flex-1 p-4 overflow-y-auto">
        {menuItems.map((item) => {
          ...
          const isFunctional = item.id === 'inicio' || item.id === 'perfil';
